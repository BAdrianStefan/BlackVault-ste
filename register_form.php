...
<head>
    <meta charset="UTF-8">
    <title>Înregistrare - BlackVault</title>
    ...
    <style>
        ...
        .btn-register { width: 100%; padding: 0.7rem; border: none; border-radius: 8px; background: #ffd700; color: #222; font-weight: bold; cursor: pointer; }
...
<body>
    ...
    <div class="register-container">
        ...
        <div class="links">
            <a href="login_form.php">Ai deja cont? Autentifică-te</a>
        </div>
    </div>
</body>
</html>